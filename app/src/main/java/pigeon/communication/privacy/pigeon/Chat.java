...
public class Chat extends BaseActivity {
                    ...
                    new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                socket = new Msocket("192.168.1.104", 5000);
    ...
    private void ddd() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final String[] sd = ddstr.split("\\|\\|\\|");//null
    ...
    public class FileClientimg {
        ...
        private String ServerAddress = "192.168.1.104";
            ...
            if (nameqt.length() < 15 && rrtt.length() < 46 && nameqt.length() > 0 && rrtt.length() > 0) {
                if (grouplista.contains(nameqt)) {
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                            String encryStrerb = Aes.encrypt(code, nameqt);//efqgg
                            String crySt = encryStrerb.substring(0, encryStrerb.length() - 1);
    ...
    private void bbb() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(getString(R.string.Versionupdate));//设置标题
        builder.setMessage(getString(R.string.Versionupdate));//设置内容
        builder.setPositiveButton(getString(R.string.sure), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                if (uup.equals("Null")) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Socket sockett = new Socket("192.168.1.104", 6000);
                    DataInputStream dis = new DataInputStream(sockett.getInputStream());
                    DataOutputStream dos = new DataOutputStream(sockett.getOutputStream());
