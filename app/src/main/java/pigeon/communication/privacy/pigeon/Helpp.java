   ...
   private TextView textView;
    ...
    public void work(View view) {
        textView.setText(
          ...
          "How does the software work?\n" +
                  ...
                  "\n" +
                  "4. The software will not obtain user's personal information (e.g. nationality, name, telephone, address, email, location,Address book, text message.... ), just send your encrypted message to the other party, except for the necessary communication conditions (your IP address, port, etc.).\n" +
                  "\n" +
                ...
                "软件如何工作？\n" +"\n"+
                  ...
                  "4，软件不会获取用户个人信息（比如：国籍，姓名，电话，地址，邮箱, 定位,通讯录，短信...等等),仅仅是把你的加密信息发到对方，除了必要的通讯条件（你的ip地址，端口，等等）。\n" +"\n"+
    ...
    public void use(View view){
        textView.setText("How to use software\n" +
                "\n" +
                "1. Software downloads. You can download the software from the GuGe application market, or download the source code from github. Or contact the author.\n" +
                "\n" +
                ...
                "\n" +
                "12, picture, audio, video, for the same key.\n" +
                "\n" +
                ...
                "\n" +
                "44. Email: weiho.1igyio2.@outlook.com.\n" +
                "\n" +
                "45. Email: Hdffhhjk@gmail.com.\n" +
                "\n" +
                "46. Email: ushytth@zoho.com.\n" +
                "\n" +
                "47, email: 2591547538@qq.com\n" +
                "\n" +
                "You can use the software for free, or you can support it.\n" +
                "\n" +
                "48,Unregistered mode used in making source code, download server (containing server source code, and the server), the server uploaded to the server (LINUX or WINDOWS.), and run the server. Select the non-login mode on the client side, enter the server IP, enter the account (which can be any non-privacy character), and you can use the non-login mode.\n"+"\n"+
                "49, homing pigeons.\n"+"\n"+"----------------------------------"+"\n"+
                "如何使用软件\n" +"\n"+
                "1,软件下载。可以到google应用市场可以下载本软件，也可以在github下载源代码。或者联系作者。\n" +"\n"+
                ...
                "44,邮箱: weiho.1igyio2.@outlook.com\n" +"\n"+
                "45,邮箱: Hdffhhjk@gmail.com\n" +"\n"+
                "46,邮箱: ushytth@zoho.com\n" +"\n"+
                "47,邮箱: 2591547538@qq.com\n" +"\n"+
                "47,你可以免费使用软件,也可以支持软件.\n" +"\n"+
                "48,非注册模式的使用，在github下载服务器源码，（里面包含服务器源代码和服务器端），把服务器端上传到服务器（LINUX或者WINDOWS系统），并且运行服务器端。在客户端选择非登录模式，输入服务器IP，输入帐号（可以是任意与你隐私无关的字符），即可使用非登录模式。\n"+"\n"+
                "49,信鸽."
        );
    ...
    public void get(View view){
        textView.setText("How to get software\n" +
                "\n" +
                "1, Can download the source code in the making. Download address: https://github.com/wfwfqw/pigeon.git\n" +"https://github.com/wfwfqw/pigeon\n"
                "\n" +
                "You can compile it yourself.\n" +
                "\n" +
                "2. It can be downloaded from GuGe apk market.\n" +
                "\n" +

                "3. Email can be sent to the following mailbox: The response may be slow..\n" +
                "\n" +
                "4. Email: weiho.1igyio2.@outlook.com.\n" +
                "\n" +
                "5. Email: Hdffhhjk@gmail.com.\n" +
                "\n" +
                "6. Email: ushytth@zoho.com.\n" +
                "\n" +
                "7, email: 2591547538@qq.com\n"+"-------------------------"+"\n"+"如何获取软件\n" +"\n"+
                "1,可以在github下载源代码.下载地址:https://github.com/wfwfqw/pigeon.git\n"+"https://github.com/wfwfqw/pigeon\n可以自己编译。\n" +"\n"+
                "2,可以在google apk市场下载。\n" +"\n"+

                "3,可以发送邮件到以下邮箱获取：回复可能会比较慢。\n" +"\n"+
                "4,邮箱: erbjetgvqe@outlook.com\n" +"\n"+
                "5,邮箱: Hdffhhjk@gmail.com\n" +"\n"+
                "6,邮箱: ushytth@zoho.com\n" +"\n"+
                "7,邮箱: 2591547538@qq.com"
