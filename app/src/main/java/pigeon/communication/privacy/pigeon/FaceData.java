...
public class FaceData {
    ...
    static {
        ...
        addString(gifFaceInfo, f10, R.mipmap.f10);
        addString(gifFaceInfo, f11, R.mipmap.f11);
        addString(gifFaceInfo, f12, R.mipmap.f12);
        addString(gifFaceInfo, f13, R.mipmap.f13);
        addString(gifFaceInfo, f14, R.mipmap.f14);
        addString(gifFaceInfo, f15, R.mipmap.f15);
        addString(gifFaceInfo, f16, R.mipmap.f16);
        addString(gifFaceInfo, f17, R.mipmap.f17);
        addString(gifFaceInfo, f18, R.mipmap.f18);
        addString(gifFaceInfo, f19, R.mipmap.f19);
        addString(gifFaceInfo, f20, R.mipmap.f20);
        addString(gifFaceInfo, f21, R.mipmap.f21);
        addString(gifFaceInfo, f22, R.mipmap.f22);
        addString(gifFaceInfo, f23, R.mipmap.f23);
        addString(gifFaceInfo, f24, R.mipmap.f24);
        addString(gifFaceInfo, f25, R.mipmap.f25);
        addString(gifFaceInfo, f26, R.mipmap.f26);
        addString(gifFaceInfo, f27, R.mipmap.f27);
        addString(gifFaceInfo, f28, R.mipmap.f28);
        addString(gifFaceInfo, f29, R.mipmap.f29);
        addString(gifFaceInfo, f30, R.mipmap.f30);
        addString(gifFaceInfo, f31, R.mipmap.f31);
        addString(gifFaceInfo, f32, R.mipmap.f32);
        addString(gifFaceInfo, f33, R.mipmap.f33);
        addString(gifFaceInfo, f34, R.mipmap.f34);
        addString(gifFaceInfo, f35, R.mipmap.f35);
        addString(gifFaceInfo, f36, R.mipmap.f36);
