...
class FFmpegask extends AsyncTask<Void, String, CommandResult> {

    private final String[] cmd;
    private final FFmpegdnle ffmpegExecuteResponseHandler;
    ...
    FFmpegask(String[] cmd, long timeout, FFmpegdnle ffmpegExecuteResponseHandler) {
        this.cmd = cmd;
